...
This policy covers `fluxzero-deploy-action`.
...
[GitHub private vulnerability reporting](https://github.com/fluxzero-io/fluxzero-deploy-action/security/advisories/new).
